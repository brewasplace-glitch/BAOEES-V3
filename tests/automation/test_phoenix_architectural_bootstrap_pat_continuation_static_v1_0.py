...
class StaticTests(unittest.TestCase):
    ...
    def test_02_orchestrator_uses_output_coverage(self):
        t=ORCH.read_text(encoding='utf-8'); self.assertIn('adapter_output_coverage',t); self.assertIn('desired_output_states',t); self.assertIn('VERSION = "1.2.0"',t)
    ...
    def test_06_runtime_1_8_1_gate(self):
        self.assertIn('VERSION = "1.8.1"',SERVER.read_text(encoding='utf-8')); self.assertIn('value.get("version") != "1.8.1"',LAUNCHER.read_text(encoding='utf-8'))
