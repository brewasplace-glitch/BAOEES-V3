...
class Phase6Tests(unittest.TestCase):
    ...
    def test_central_policy_version_23(self):
        ...
        self.assertEqual(d["version"],"2.3.0")
    ...
    def test_executor_registry_version_11_and_engine_registry_14(self):
        self.assertEqual(load("capability_executor_registry_v1.json")["version"],"1.1.0")
        self.assertEqual(load("engine_registry_v1.json")["version"],"1.4.0")
