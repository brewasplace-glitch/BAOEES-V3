...
from .energyplus_adapter_v5_6_0 import EnergyPlusWindowsAdapter
from .opensees_adapter_v5_5_0 import OpenSeesPyAdapter
...
ADAPTERS = {
    ...
    "energyplus": EnergyPlusWindowsAdapter,
    "opensees": OpenSeesPyAdapter,
