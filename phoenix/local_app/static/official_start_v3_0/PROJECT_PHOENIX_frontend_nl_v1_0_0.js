...
const REASONS = new Map([
  ...
  ["PROJECT_LOCATION_REQUIRED", "Expliciete projectlocatie vereist"],
  ["PROJECT_COUNTRY_JURISDICTION_REQUIRED", "Projectland of gebiedsdeel vereist voor jurisdictie"],
  ["STRUCTURAL_ACTION_LOAD_INPUT_REQUIRED", "Projectspecifieke belastingen en combinaties vereist"],
  ["STRUCTURAL_SOLVER_BASIS_AND_ELEMENT_ASSIGNMENTS_REQUIRED", "Solverbasis, materialen, doorsneden en elementtoewijzingen vereist"],
  ["STRUCTURAL_SOLVER_ELEMENT_ASSIGNMENTS_INCOMPLETE", "Solver-elementtoewijzingen zijn onvolledig"],
  ["NORMALIZED_SOLVER_RESULTS_REQUIRED", "Genormaliseerde solverresultaten en raw evidence vereist"],
  ["STRUCTURAL_CODE_BASIS_AND_MEMBER_VERIFICATION_RULES_REQUIRED", "Codebasis en member-verificatieregels vereist"],
  ["GLOBAL_STABILITY_ENGINEERING_INPUT_REQUIRED", "Stabiliteits-, tweede-orde- en robuustheidscontroles vereist"],
  ["CONNECTION_SUPPORT_VERIFICATION_INPUT_REQUIRED", "Verbinding- en opleggingsverificatiegegevens vereist"],
  ["FOUNDATION_GEOTECHNICAL_INTERFACE_INPUT_REQUIRED", "Geotechnische funderingsinterfacegegevens vereist"],
  ["FOUNDATION_DESIGN_REINFORCEMENT_INPUT_REQUIRED", "Funderingsontwerp en wapeningsevidence vereist"],
  ["ENGINEERING_PACKAGE_QAQC_INPUT_REQUIRED", "Engineering package en QA/QC-evidence vereist"],
  ["HUMAN_ENGINEERING_REVIEW_AND_RELEASE_AUTHORIZATION_REQUIRED", "Menselijke engineering review en vrijgave-autorisatie vereist"],
  ["REVISION_IFC_PACKAGE_INPUT_REQUIRED", "Revisie- en IFC-documentcontrolegegevens vereist"],
  ["PROJECT_LOCATION_REQUIRED_FOR_LOCAL_MATERIALS", "Projectlocatie vereist voor lokale materiaalkeuze"],
  ["LOCAL_MATERIAL_AVAILABILITY_REQUIRED", "Lokaal verkrijgbare materiaal- of productkeuze vereist"],
  ["LOCAL_MATERIAL_AVAILABILITY_CONFIRMATION_REQUIRED", "Actuele lokale beschikbaarheidsbevestiging vereist"],
  ["LOCAL_MATERIAL_REQUIRED_IMPORT_CANDIDATE_ONLY", "Alleen importkandidaat gevonden; lokale keuze ontbreekt"],
  ["LOCAL_MATERIAL_UNAVAILABLE", "Benodigd materiaal is lokaal niet beschikbaar"],
  ["LOCAL_MATERIAL_AVAILABILITY_REQUIRED_FOR_COST_PLAN", "Lokale materiaalbeschikbaarheid vereist voor kostenplan"],
  ["LOCAL_MATERIAL_SUPPLY_GATE_NOT_PASSED", "Lokale materiaal- en productbeschikbaarheid is nog niet volledig bevestigd"],
  ["LOCAL_STRUCTURAL_MATERIAL_AVAILABILITY_REQUIRED", "Lokale constructiematerialen moeten vóór solvergebruik bevestigd zijn"],
  ["STRUCTURAL_SOLVER_MATERIAL_NOT_LOCALLY_CONFIRMED", "Solvermateriaal is niet als lokaal verkrijgbaar bevestigd"],
  ["MATERIAL_SUPPLY_PRODUCTS_ARRAY_REQUIRED", "Materiaalcatalogus bevat geen geldige productlijst"],
  ["AVAILABILITY_EVIDENCE_STALE", "Beschikbaarheidsbewijs is verouderd"],
  ["AVAILABILITY_EVIDENCE_EXPIRED", "Beschikbaarheidsbewijs is verlopen"],
  ["CURRENT_STRUCTURAL_ACTION_LOAD_BASIS_REQUIRED", "Actuele projectspecifieke belastings- en combinatiebasis vereist"],
  ["PROJECT_JURISDICTION_REQUIRED_FOR_STRUCTURAL_LOAD_BASIS", "Projectjurisdictie vereist voor belastingsbasis"],
  ["STRUCTURAL_LOAD_SOURCE_CURRENT_STATUS_REQUIRED", "Actuele geldigheidsstatus van belastingsbron vereist"],
  ["STRUCTURAL_LOAD_SOURCE_EXPIRED", "Belastings- of normbron is verlopen"],
  ["STRUCTURAL_ACTION_LOAD_INPUT_INCOMPLETE", "Belastingsbron bevat geen complete Phoenix-invoer"],
  ["STRUCTURAL_SELF_WEIGHT_ACTION_REQUIRED", "Expliciete eigengewichtsactie vereist"],
  ["SITE_DRAWING_PARSE_FAILED", "Situatietekening kon niet betrouwbaar worden geïnterpreteerd"],
  ["DXF_UNITS_REQUIRED", "DXF-eenheden vereist voor betrouwbare perceelmaatvoering"],
  ["DWG_TO_DXF_CONVERSION_REQUIRED", "DWG moet voor perceelgeometrie naar DXF worden geconverteerd"],
  ["RASTER_SITE_GEOMETRY_EXTRACTION_REQUIRED", "Raster-situatietekening vereist een geometrie-extractor"],
  ["PDF_TEXT_EXTRACTION_UNAVAILABLE", "PDF-tekstextractor niet beschikbaar"],
  ["PYMUPDF_REQUIRED_FOR_ADVANCED_PDF_SITE_INTELLIGENCE", "PyMuPDF vereist voor geavanceerde PDF-situatieanalyse"],
  ["PDF_NO_VALIDATED_SITE_FACTS", "PDF bevat nog geen betrouwbaar gevalideerde perceelfeiten"],
  ["LOCAL_STRUCTURAL_PRODUCT_TECHNICAL_EVIDENCE_REQUIRED", "Lokaal product gevonden; constructieve product-/sterkte-evidence vereist"],
